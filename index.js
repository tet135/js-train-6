...
function printProductDetails(obj) {
  ...
  return console.log(productName, price, manufacturer.companyName, manufacturer.country);
  ...
  //так теж працює!!!!
  // return console.log(obj["productName"], obj["price"], obj["manufacturer"]["companyName"], obj["manufacturer"]["country"]);
}
...
console.log(addProperty([1, 2, 3, 4, 5]))
...
// Завдання 14: Додайте нову властивість до вбудованого об'єкту Array через літерал.
// Створюємо функцію, яка буде додавати нову властивість до масиву
function addPropertyViaLiteral(array) {
...
console.log("Завдання 14 ====================================");
console.log(addPropertyViaLiteral([1, 2, 3, 4, 5]))

let newArr1 = [addPropertyViaLiteral([1, 2, 3, 4, 5])];
// Створимо масив newArr з новою властивістю за допомогої нашої функції в яку передамо [1, 2, 3, 4, 5]

// Розкоментуйте рядок нижче після виконня завдання для перевірки
console.log(newArr1.customProperty); // Виведе myProperty